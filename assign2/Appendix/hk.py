...
while (acflag): # Keep running until we find a solution or a solution is not possible
    ...
    if nac>100:
	acflag=0
    ac = numpy.add(ac, numpy.add(Eac, numpy.absolute(Eac))) # Add b to the addition of E and the absolute value of E
bc=[1 for x in bclst]
while (bcflag): # Keep running until we find a solution or a solution is not possible
    ...
    if nbc>1000:
	bcflag=0
    bc = numpy.add(bc, numpy.add(Ebc, numpy.absolute(Ebc))) # Add b to the addition of E and the absolute value of E
