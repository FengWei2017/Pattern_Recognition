...
write=open("wei8-classified-rpca.txt","a")
...
for sample in testlst:
    ...
    afsample=dot(fasample,apca.components_[:,[0,1]])
    bfsample=dot(fbsample,bpca.components_[:,[0,1]])
    cfsample=dot(fcsample,cpca.components_[:,[0,1]])
